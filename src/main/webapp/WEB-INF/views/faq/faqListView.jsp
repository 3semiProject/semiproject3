...
<head>
    ...
    <style type="text/css">
        ...
        .f_question1 > ul > li, .f_answer1 > ul > li {
            float: left;
        }
        ...
        .f_answer1 > ul > li:nth-child(1) {
            width: 10%;
            text-align: center;
        }

        .f_answer1 > ul > li:nth-child(2) {
            width: 15%;
            text-align: center;
        }

        .f_answer1 > ul > li:nth-child(3) {
            width: 61%;
            text-align: center;
        }

        .f_answer1 > ul > li:nth-child(4) {
            width: 7%;
            text-align: center;
        }

        .f_answer1 > ul > li:nth-child(5) {
            width: 7%;
            text-align: center;
        }

        .f_question1 > ul > li:nth-child(1) {
            width: 10%;
            text-align: center;
        }

        .f_question1 > ul > li:nth-child(2) {
            width: 15%;
            text-align: center;
        }

        .f_question1 > ul > li:nth-child(3) {
            width: 61%;
        }
            ...
            <c:forEach items="${ list }" var="f">
                <ul class="fnq">
                    <li class="f_question1">
                        <ul class="clearfix"
                            style="border-radius: 10px; margin:5px; border: 1px solid #50b5be; font-weight:bold; background-color:rgba(140,251,214,0.74);">
                            <li>F</li>
                            <li>${ f.faq_cat }</li>
                            <li>${ f.faq_title }</li>
                    ...
                    <li class="f_answer1">
                        <ul class="clearfix"
                            style="border-radius: 10px; margin:5px; border: 1px solid #50b5be; font-weight:bold; background-color:rgba(250,248,248,0.74);">
                            <li>A</li>
                            <li>${ f.faq_cat }</li>
                            <li>${ f.faq_content }</li>
                            <li>
