...
<head>
    ...
    <style type="text/css">
        ...
        =
        "https://cdn.dribbble.com/assets/neue-haas-grotesk/NeueHaasGrotTextRound-75Bold-Web-f2ff2f34217e3fdab82c30ef689f5be3fb86a8e4218a1906a9399d0354a95d45.woff2"
        as
...
<div id="mainContain">
    ...
    <div class="vars">
        ...
        <div class="navigation">
            <div>
                <img id="img_today" alt="today 강조"
                     src="${ pageContext.servletContext.contextPath }/resources/images/diary/today.jpg">
            </div>
            <!-- 이전 -->
            <div class="date">
            ...
            <c:forEach var="w" items="${week}" varStatus="status">
                <div>
                    ...
                    <c:if test="${!empty w.diary_category}">
                        <div class="dia1"><img id="weekDia" alt="해당일 diary 존재"
                                               src="${ pageContext.servletContext.contextPath }/resources/images/diary/weekDia.jpg">
                        </div>
                    </c:if>
                    <c:if test="${empty w.diary_category}">
        ...
        <div class="target">
            ...
            <table>
                <tr>
                    ...
                    <td>목표까지 <fmt:formatNumber value="${goal.target_weight - goal.current_weight}" pattern="0.0#"/>kg
                    </td>
        ...
        <div class="tabs">
            <c:set var="moveURL"
                   value="diary_moveDiary.do?user_id=${sessionScope.loginMember.user_id}&diary_post_date=${diary.diary_post_date}&diary_category="/>
    ...
    <div id="diaryPart">
        <c:if test="${diary.diary_no ne 0}">
            <c:set var="recommandKcal"
                   value="${(goal.standard_weight * goal.energy_demand)+(goal.current_weight - goal.standard_weight)*7000/goal.dday * 3/5}"/>
            ...
            <table class="dtotal">
                <tr>
                    ...
                    <td>&nbsp; ⇒ &nbsp; 잔여 <fmt:formatNumber value="${recommandKcal-currentKcal}" pattern="0.#"/>kcal
                    </td>
                </tr>
            </table>
        </c:if>
                            ...
                            <tr class="dimg">
                                <td rowspan="3">
                                    <c:if test="${empty D.diary_image}">
                                        <img alt="${D.diary_no}의 이미지"
                                             src="${ pageContext.servletContext.contextPath }/resources/images/diary/noimage.jpg">
                                    </c:if>
                                    <c:if test="${!empty D.diary_image}">
                                        <img alt="${D.diary_no}의 이미지"
                                             src="${ pageContext.servletContext.contextPath }/resources/diary_upfile/${D.diary_image}">
                                    </c:if>
                                </td>
                                <th id="dtime">
                                    <h3> 🍴 &nbsp;<fmt:formatDate value="${D.diary_post_date}" type="date"
                                                                 pattern="a HH:mm"/></h3>
                                </th>
                            </tr>
                            <tr>
                                            ...
                                            <c:if test="${eat.diary_no eq D.diary_no}">
                                                ...
                                                <tr>
                                                    <td colspan="2" class="even-row">
                                                        ↳ 탄수화물 ${eat.eat_carbohydrate}g &nbsp; 단백질 ${eat.eat_protein}g
                                                        &nbsp; 지방 ${eat.eat_fat}g &nbsp;&nbsp;
                                                    </td>
                                                </tr>
                                            </c:if>
                ...
                <c:if test="${status.last}">
                    <table class="dtotal">
                        <tr>
                            ...
                            <td> &nbsp; &nbsp; ⇒ &nbsp; ${sum.eat_kcal} / <fmt:formatNumber value="${recommandKcal}"
                                                                                            pattern="0"/> kcal
                            </td>
                        </tr>
                    </table>
                    ...
                    <table class="T">
                        ...
                        <tr>
                            <td><img alt="탄수화물관련 이미지"
                                     src="${ pageContext.servletContext.contextPath }/resources/images/diary/noimage.jpg">
                            </td>
                            <td><img alt="단백질관련 이미지"
                                     src="${ pageContext.servletContext.contextPath }/resources/images/diary/noimage.jpg">
                            </td>
                            <td><img alt="단백질관련 이미지"
                                     src="${ pageContext.servletContext.contextPath }/resources/images/diary/noimage.jpg">
