...
<body>
	...
	<hr>
	<div>
		<p id="title">FREE 게시글 수정</p>
	</div>
	<div>
		<form action="freeupdate.do" method="post"
			enctype="multipart/form-data" name="boardform">
			<input type="hidden" name="free_no" value="${ free.free_no }">
			<input type="hidden" name="originfile_free" value="${ free.originfile_free }">
			<input type="hidden" name="renamefile_free" value="${ free.renamefile_free }">
			<table width="100%" border="1px solid" cellpadding="0"
				...
				<tr height="40">
					<th>제목</th>
					<td><input name="free_name" type="text" value="${ free.free_name }" style="width: 700px;" /></td>
				</tr>
				<tr>
					<th>내용</th>
