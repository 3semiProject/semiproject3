...
<body>
	...
	<div>
		<form action="freerepinsert2.do" method="post"
			enctype="multipart/form-data" name="boardform">
			<input type="hidden" name="free_reply_ref" value="${ free.free_reply_ref }">
			<input type="hidden" name="free_ref" value="${ free.free_ref }">
			<input type="hidden" name="free_name" value="${ free.free_ref }번 게시물 ${ free.free_reply_ref }번째 댓글의 댓글">
			<table width="100%" border="1px solid" cellpadding="0"
				...
				<tr  height="40">
					<th>내용</th>
					<td><textarea name="free_value" style="width: 90%;"></textarea>
					</td>
				</tr>
				<tr>
