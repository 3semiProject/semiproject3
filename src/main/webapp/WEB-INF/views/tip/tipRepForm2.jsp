...
<body>
	...
	<div>
		<form action="tiprepinsert2.do" method="post"
			enctype="multipart/form-data" name="boardform">
			<input type="hidden" name="tip_reply_ref" value="${ tip.tip_reply_ref }">
			<input type="hidden" name="tip_ref" value="${ tip.tip_ref }">
			<input type="hidden" name="tip_name" value="${ tip.tip_ref }번 게시물 ${ tip.tip_reply_ref }번째 댓글의 댓글">
			<table width="100%" border="1px solid" cellpadding="0"
				...
				<tr  height="40">
					<th>내용</th>
					<td><textarea name="tip_value" style="width: 90%;"></textarea>
					</td>
				</tr>
				<tr>
