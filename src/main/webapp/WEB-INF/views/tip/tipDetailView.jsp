...
<body>
	...
	<div>
			<table width="100%" border="1px solid" cellpadding="0"
				cellspacing="0">
				<tr>
				<c:if test="${ requestScope.tip.user_id eq sessionScope.loginMember.user_id }">
				...
				<tr height="100">
					<th>게시글 추천</th>
					<td><!-- likeFree -->
					<c:if test="${!empty likeTip.user_id and likeTip.user_id eq sessionScope.loginMember.user_id}">
				...
				<tr height="35">
					...
					<th>${t.user_id}</th>
					<td>&nbsp; &nbsp; ${t.tip_value} &nbsp;
					<c:if test="${ t.user_id eq sessionScope.loginMember.user_id }">
