...
<div style="display: flex; border: 1px solid #D1D1D1;">
	...
	<div style="width: 60%;">
		<select id="optionLink" name="searchtype" onchange="if(this.value) location.href=(this.value);">
			...
			<option value="adBFlist.do?page=1" selected="selected">BF&AF</option>
     ...
     <div id='liSearchOption'>
     	<form action="adBfafsearch.do?page=1" method="post">
         <div style="display: flex; border: 1px solid #D1D1D1;">
...
<div id="bfafWrapper">
        ...
        <br>
        <!-- 페이징 처리 -->
		<c:import url="/WEB-INF/views/admin/bfafsearchpaging.jsp" />
    </div>
 <br>
<hr>
