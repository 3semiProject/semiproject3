...
.slidebox .slide-control [class*="control"] label.prev {
	...
	background: transparent
		url('${ pageContext.servletContext.contextPath }/resources/img/left-arrow.png')
...
.slidebox .slide-control [class*="control"] label.next {
	right: 0px;
	background: transparent
		url('${ pageContext.servletContext.contextPath }/resources/img/right-arrow.png')
		center center/50% no-repeat;
}
...
<div id="mainContain">
    ...
    <c:if test="${ empty sessionScope.loginMember }">
		...
		<div class="slide-control">
			<div class="control01">
				<label for="slide05" class="prev"></label> <label for="slide02" class="next"></label>
			</div>
			<div class="control02">
			...
			<div class="control04">
				<label for="slide03" class="prev"></label> <label for="slide05" class="next"></label>
			</div>
			<div class="control05">
				<label for="slide04" class="prev"></label> <label for="slide01" class="next"></label>
			</div>
		</div>
	</div>
