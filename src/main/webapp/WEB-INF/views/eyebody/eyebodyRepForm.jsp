...
<body>
	...
	<div>
		<form action="eyebodyrepinsert.do" method="post"
			enctype="multipart/form-data" name="boardform">
			<input type="hidden" name="eyebody_ref" value="${ eyebody_ref }">
			<input type="hidden" name="eyebody_name" value="${ eyebody_ref }번 게시물 댓글">
