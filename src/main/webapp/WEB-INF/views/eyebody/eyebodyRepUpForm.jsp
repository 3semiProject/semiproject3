...
<body>
	...
	<div>
		<form action="eyebodyrepupdate.do" method="post"
			...
			<input type="hidden" name="eyebody_name" value="${ eyebody.eyebody_name }">
			<table width="100%" border="1px solid" cellpadding="0"
				...
				<tr height="40">
					<th>내용</th>
					<td align="left"><textarea name="eyebody_value" style="width: 90%;">${ eyebody.eyebody_value }</textarea>
					</td>
				</tr>
				<tr>
