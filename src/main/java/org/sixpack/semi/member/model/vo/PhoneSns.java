...
public class PhoneSns {
	...
	public void send_msg(String tel, String rand) {
        ...
        // 개인 인증키
        String accessKey = "iPM1eiV5dWL5vzkTkiSo";
        // 2차 인증을 위해 서비스마다 할당되는 service secret
        String secretKey = "WJG8rK5ocT7hecI8v4zhsESGivtaSIBJ2QYw9WMD";
        // 프로젝트에 할당된 SMS 서비스 ID
        String serviceId = "ncp:sms:kr:305153979284:damunity";
        // 요청 method
        String method = "POST";
