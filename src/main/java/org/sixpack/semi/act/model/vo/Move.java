...
public class Move implements java.io.Serializable{
	...
	private int move_met; //met
	private String move_intensity; //운동강도

	protected Move() {
	}
	protected Move(String move_code, String move_name, int move_met, String move_intensity) {
		super();
	...
	public String toString() {
		return "Move [move_code=" + move_code + ", move_name=" + move_name + ", move_met=" + move_met + ", move_intensity="
				+ move_intensity + "]";
	}
	public String getMove_no() {
		return move_code;
	}
	public void setMove_no(String move_code) {
		this.move_code = move_code;
	}
	...
	public int getMove_met() {
		return move_met;
	}
	public void setMove_met(int move_met) {
		this.move_met = move_met;
	}
