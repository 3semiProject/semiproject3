...
public class ActRec implements java.io.Serializable {
    ...
    public ActRec(int rec_act_code, int rec_act_lev, String rec_act_title, String rec_act_image, String rec_act_link) {
        this.rec_act_code = rec_act_code;
        this.rec_act_lev = rec_act_lev;
    ...
    public int getRec_act_lev() {
        return rec_act_lev;
    }

    public void setRec_act_lev(int rec_act_lev) {
        this.rec_act_lev = rec_act_lev;
    }
    ...
    public String toString() {
        return "ActRec{" +
                "rec_act_code=" + rec_act_code +
                ", rec_act_lev=" + rec_act_lev +
                ", rec_act_title='" + rec_act_title + '\'' +
                ", rec_act_image='" + rec_act_image + '\'' +
                ", rec_act_link='" + rec_act_link + '\'' +
                '}';
    }
}