...
public interface NoticeService {
	...
	ArrayList<Notice> selectSearchTitle(Searchs searchs);
	ArrayList<Notice> selectSearchWriter(Searchs searchs);
	ArrayList<Notice> selectSearchContent(Searchs searchs);
