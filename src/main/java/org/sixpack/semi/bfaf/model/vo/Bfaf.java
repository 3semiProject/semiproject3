...
public class Bfaf implements java.io.Serializable {
	...
	public Bfaf(int bfaf_no, String bfaf_name, String user_id, Date write_bfaf_date, int click_bfaf_no,
			String bfaf_value, String originfile_bfaf, String renamefile_bfaf, int bfaf_ref, int bfaf_reply_ref,
			int bfaf_reply_lev, int bfaf_reply_seq, int bfaf_like_no) {
		super();
	...
	public String toString() {
		return "Bfaf [bfaf_no=" + bfaf_no + ", bfaf_name=" + bfaf_name + ", user_id=" + user_id + ", write_bfaf_date="
				...
				+ ", originfile_bfaf=" + originfile_bfaf + ", renamefile_bfaf=" + renamefile_bfaf + ", bfaf_ref="
				+ bfaf_ref + ", bfaf_reply_ref=" + bfaf_reply_ref + ", bfaf_reply_lev=" + bfaf_reply_lev
				+ ", bfaf_reply_seq=" + bfaf_reply_seq + ", bfaf_like_no=" + bfaf_like_no + "]";
	}
